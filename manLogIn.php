...
<form class="form1" name="loginMan" action="manLogIn.php" method="POST">
<fieldset>
<legend>Manager Log-in</legend>
<br>
<input type="text" placeholder="Username" name="username" autofocus/><br>
   
<input type="password" placeholder="Password" name="password"/><br>

<button type="submit" class="subbut" name='login' value="Log-in" onclick="valid3(); return false;">Login</button>
